...
| `0.3` | In progress | Vocabulary and primitives, complete visual-export fidelity, grid system, component prop types, provenance — and the package model ([RFC-0042](rfcs/0042-multi-document-packages.md) multi-document packages, [RFC-0043](rfcs/0043-standalone-guix.md) standalone `.guix`, [RFC-0044](rfcs/0044-slots.md) slots). |
